...
| ALLOW | 업계 전문용어(OKR·KPI·KRA·MBO·NSM·MAU·DAU·MRR·ARR·NPS·CSAT·CTR·CVR·LTV·CAC·PDCA) · 고유명사 · 법조문 |
| CONVERT | 라벨 발견 → 실명·평문 풀어쓰기. 예) "Plan-Do-Check-Act·Check 담당" → 결과 평문 / "주기적 리뷰 프로토콜" → 진행 흐름 평문 |
| SELF_CHECK | 대시보드·리뷰보고서 출력 직전에서 자체 스캔. 1개라도 발견 = 차단·재작성. paper-engine cascade 경유 시 INV 13 자동 적용 |
